            ...
            <SideBar>
                <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
                        <div className="text-center pb-12">
                            ...
                            <button class="p-2 pl-5 pr-5 bg-transparent border-2 border-baseColor text-blue-500 text-lg rounded-lg hover:bg-baseColor hover:text-gray-100 focus:border-4 focus:border-blue-300">click here</button>
