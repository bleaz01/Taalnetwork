...
const Register = () => {
    return (
        <div className="container mx-auto my-auto bg-baseColor">
            <div class=" bg-baseTextColor  min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
