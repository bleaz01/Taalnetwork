...
<section class="max-w-4xl w-2xl p-6 bg-baseColor rounded-md shadow-md dark:bg-gray-800 mt-20">
    ...
    <form>
        ...
        <button
          type="button"
          class="border border-whiteColor text-indigo-500 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:text-white hover:bg-indigo-600 focus:outline-none focus:shadow-outline"
        >
          Send
        </button>
        </div>
