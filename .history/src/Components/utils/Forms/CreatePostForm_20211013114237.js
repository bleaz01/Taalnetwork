...
<section class="max-w-4xl w-2xl p-6 bg-baseColor rounded-md shadow-md dark:bg-gray-800 mt-20">
    ...
    <form>
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1">
            <div>
                <label class="text-whiteColor dark:text-gray-200" for="username">Message</label>
                <input name="feed" id="feed" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"/>
            </div>
            <div>
