...
const CreatePostForm = () => {
    return (
<section class="max-w-4xl p-6 bg-baseColor rounded-md shadow-md dark:bg-gray-800 mt-20">
    <h1 class="text-xl font-bold text-white capitalize dark:text-white">Account settings</h1>
    <form>
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1">
            <div>
                <label class="text-whiteColor dark:text-gray-200" for="username">Username</label>
            ...
            <div>
                ...
                <div class="space-y-1 text-center">
                  ...
                  <div class="flex text-sm text-gray-600">
                    <label for="file-upload" class="relative cursor-pointer bg-whiteColor p-4 rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
