                    ...
                    <div className=" w-4/6 border-baseColor rounded-lg border-2 hover:bg-teal-100">
                        <div className="flex justify-between w-full items-center p-2 pl-2 border-transparent">
                            <div className="w-6 flex flex-col items-center">
                                <div className="flex  relative w-10 h-10 bg-orange-500 justify-center items-center pl-3 m-1 mr-2 w-4 h-4 mt-1 rounded-full ">
                                    <img className="rounded-full" alt="A" src="https://randomuser.me/api/portraits/men/62.jpg"/> 
                                </div>
                            </div>
                                <div class="w-auto h-auto">
                                    <div class="flex-1 h-full">
                                    <div onClick={() => console.log('add post')}class="flex items-center justify-center flex-1 h-full p-2 bg-blue-800 text-white shadow rounded-full">
                                        <div class="relative">
