...
const Home = () => {
    return (
        <div className="">
            <Navbar/>
            <SideBar>
            <div className="cursor-pointer w-auto border-gray-100 rounded-t border-b hover:bg-teal-100">
                <div className="flex w-1/2 items-center p-2 pl-2 border-transparent border-l-2 relative hover:border-teal-100">
