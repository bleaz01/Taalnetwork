              ...
              <div className={`${openFeed === false ? "hidden" : ""}`}>
                ...
                <div class="space-y-4">
                  ...
                  <div className="flex">
                    ...
                    <div onClick={()=>} className="flex-1 border rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
                      ...
                      <div className="mt-4 flex items-center">
                        ...
                        <div className={`${openComment === false ? 'hidden' : "text-sm text-gray-500 font-semibold"}`}>
                          5 Replies
                        </div>
                      </div>
                    </div>
