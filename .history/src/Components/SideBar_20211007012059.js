...
const SideBar = (props) => {
    return (
                <div className="flex flex-no-wrap ">
                        ...
                        <div className="px-8">
                            ...
                            <ul className="mt-12">
                                ...
                                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-sm text-white  ml-2">Products</span>
                                    </div>
                                ...
                                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-sm text-white  ml-2">Performance</span>
                                    </div>
                                </li>
                                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                    <div className="flex items-center">
                                ...
                                <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-sm text-white  ml-2">Invoices</span>
                                    </div>
                                    <div className="py-1 px-3 bg-gray-700 rounded text-white flex items-center justify-center text-xs">25</div>
                                </li>
                                <li className="flex w-full justify-between text-gray-600 hover:text-white cursor-pointer items-center mb-6">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-sm text-white  ml-2">Inventory</span>
                                    </div>
                                </li>
                                <li className="flex w-full justify-between text-gray-600 hover:text-white cursor-pointer items-center">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-sm text-white  ml-2">Settings</span>
                                    </div>
                                </li>
                            </ul>
                            <div className="flex justify-center mt-48 mb-4 w-full">
                                <div className="relative ">
                                    ...
                                    <input className=" bg-gray-700 focus:outline-none rounded w-full text-sm text-white text-white bg-gray-100 pl-10 py-2" type="text" placeholder="Search" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="px-8">
                            ...
                            <ul className="mt-12">
                                <li className="flex w-full justify-between text-gray-300 hover:text-white cursor-pointer items-center mb-6">
                                    ...
                                    <div className="py-1 px-3 bg-gray-700 rounded text-white flex items-center justify-center text-xs">5</div>
                                </li>
                                <li className="flex w-full justify-between text-gray-600 hover:text-white cursor-pointer items-center mb-6">
                                    <div className="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-puzzle" width={18} height={18} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <div className="py-1 px-3 bg-gray-700 rounded text-white flex items-center justify-center text-xs">8</div>
                                </li>
                                <li className="flex w-full justify-between text-gray-600 hover:text-white cursor-pointer items-center mb-6">
                                    <div className="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-compass" width={18} height={18} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <div className="flex justify-center mt-48 mb-4 w-full">
                                <div className="relative ">
                                    ...
                                    <input className=" bg-gray-700 focus:outline-none rounded w-full text-sm text-white bg-gray-100 pl-10 py-2" type="text" placeholder="Search" />
                                </div>
                            </div>
                        </div>
                        <div className="px-8 border-t border-gray-700">
                    ...
                    <div className="container mx-2 py-2 h-64 md:w-4/5 w-11/12 px-6">
