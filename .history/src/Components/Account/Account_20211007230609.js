                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
                    ...
                    <div className="flex flex-wrap justify-center">
                        ...
                        <div className="py-6 px-3 mt-32 sm:mt-0">
                            <button className="bg-baseColor active:bg-baseColor-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="button">
                                <a href='/'>Home</a>
                            </button>
                        </div>
                        </div>
