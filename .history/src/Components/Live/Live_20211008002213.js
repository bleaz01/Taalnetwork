...
const Live = () => {
    return (
        <div>
            <Navbar/>
            <SideBar>
                <div class="w-96 h-64 m-12 bg-secondeColor relative group">
                    <span class="absolute -top-2 left-0 border-0.25 border-greenColor transition-transform transform translate-y-2 ease duration-100"></span>
