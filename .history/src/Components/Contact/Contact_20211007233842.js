    ...
    return (
        <div class="flex flex-row h-screen antialiased text-gray-800">
            <div class="bg-secondeColor flex flex-row w-96 flex-shrink-0 bg-gray-100 p-4">
              <div class="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-baseColor rounded-3xl">
                <a href="#"
              ...
              <div class="flex bg-greyColor flex-col w-full h-full pl-4 pr-4 py-4 -mr-4">
            ...
            <div class="bg-secondeColor flex flex-col h-full w-full bg-white px-4 py-6">
              ...
              <div class="bg-greyColor h-full overflow-hidden py-4 rounded-lg">
              ...
              <div class="flex flex-row items-center">
                <div class="bg-baseColor flex flex-row items-center w-full border rounded-3xl h-12 px-2">
